...
scp -i ~/.ssh/gatling_sshkey.priv $GATLING_REPORT_DIR/$REPORT_SUBDIR/simulation.log $USER_NAME@$ORG_HOST:$GATHER_REPORTS_DIR/$REPORT_SUBDIR/simulation-`hostname`.log